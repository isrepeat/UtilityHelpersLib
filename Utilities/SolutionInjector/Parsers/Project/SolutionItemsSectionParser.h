...
namespace Core {
	namespace Parsers {
		namespace Project {
			class SolutionItemsSectionParser : public ISectionParser {
			public:
				std::ex::shared_ptr<Model::ParsedSectionBase> TryParse(const Model::Raw::Section& section) override {
					auto result = Model::details::MakeSharedParsedSection<Model::Project::ParsedSolutionItemsSection>(section);
