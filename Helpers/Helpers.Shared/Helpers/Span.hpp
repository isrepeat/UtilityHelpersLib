...
namespace std {
    ...
    class tuple_size<HELPERS_NS::span<ElementType, Extent>>
        : public integral_constant<size_t, Extent> {};

    template <typename ElementType>
    class tuple_size<HELPERS_NS::span<
        ElementType, HELPERS_NS::dynamic_extent>>; // not defined

    template <size_t I, typename ElementType, size_t Extent>
    class tuple_element<I, HELPERS_NS::span<ElementType, Extent>> {
    public:
        static_assert(Extent != HELPERS_NS::dynamic_extent &&
            I < Extent,
            "");
