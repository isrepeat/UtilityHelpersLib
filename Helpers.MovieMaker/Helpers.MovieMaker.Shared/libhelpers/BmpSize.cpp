...
BmpSize::BmpSize()
    : logicalSize(0.f, 0.f), logicalDpi(BmpSize::DefaultDpi)
{}

BmpSize::BmpSize(const Structs::Float2 &logicalSize)
    : logicalSize(logicalSize), logicalDpi(BmpSize::DefaultDpi)
{}

BmpSize::BmpSize(const Structs::Float2 &logicalSize, const Structs::Float2 &logicalDpi)
    : logicalSize(logicalSize), logicalDpi(logicalDpi)
{}
