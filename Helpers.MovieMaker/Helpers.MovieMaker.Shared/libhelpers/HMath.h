...
namespace H {
    ...
    public:
        ...
        */
        ...
        static ::AABB GetAABBFromRotatedPoints(float radAngle, std::vector<DirectX::XMFLOAT2> vecPoints);
        ...
        static bool Math::AreaInsideOfArea(const DirectX::XMFLOAT2& container, const DirectX::XMFLOAT2& insider);

        static bool XMVector3IsNull(DirectX::XMVECTOR& vec);
