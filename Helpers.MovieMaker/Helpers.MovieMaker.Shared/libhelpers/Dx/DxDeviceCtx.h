#pragma once
#include <Helpers/Dx/DxDeviceCtx.h>
...
//
//private:
//	HH::Dx::MFDXGIDeviceManagerLock GetMFDXGIManagerLock(const std::unique_ptr<DxDeviceCtx>& dxDeviceCtx);
...
//
//private:
//	HH::ThreadSafeObject<std::mutex, DxDeviceCtxWrapper> dxDeviceCtxWrapperSafeObj;
//};
