...
#include "Hashers.h"
#include "ImageContainerEnum.h"
#include "Filesystem\IStreamFS.h"
...
public:
    ...
    uint32_t GetFrameRectByteSize(IWICBitmapSource* frame, const WICRect& segmentArea) const;
    uint32_t GetFrameRectStride(IWICBitmapSource* frame, const WICRect& segmentArea) const;
    DirectX::XMUINT2 GetFrameSize(IWICBitmapSource *frame) const;
    DirectX::XMUINT2 GetFrameRotatedSize(IWICBitmapSource *frame) const;
...
#pragma comment( lib, "shcore.lib" )
    ...
    static ImagePixels LoadDxPBgra32Image(Filesystem::IStream *stream, uint32_t maxSize = UINT_MAX);
    static ImagePixels LoadDxPBgra32Image(const Microsoft::WRL::ComPtr<IStream> &stream, uint32_t maxSize = UINT_MAX);
    static ImagePixels LoadDxPBgra32Image(const Microsoft::WRL::ComPtr<IWICBitmapDecoder> &decoder, uint32_t maxSize = UINT_MAX);
    ...
    static Microsoft::WRL::ComPtr<ID2D1Bitmap1> LoadBmpFromPath(const Microsoft::WRL::ComPtr<IStream> &stream,
